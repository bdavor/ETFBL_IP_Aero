...
function setTable(){
	document.getElementById("tablePetOdlazaka").innerHTML = "";
	var red = red_prvi;
	if(podatci.length >= 5){
		for(var i = 0; i < 5; i++){
...
document.getElementById("tablePetOdlazaka").innerHTML = red;
}
...
function ucitaj(){
	...
	request.open("GET","GlavniServlet?action=petSljedecihOdlazakaZahtjev",true)
	request.send(null)
}